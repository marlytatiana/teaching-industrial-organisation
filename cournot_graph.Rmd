...
This is a simple code for representing the Cournot equilibrium for a duopoly when market demand is $Q(P)=200-P$ and each firm’s cost function is $C(q_i )=20q_i$, where $i=1,2$. 
